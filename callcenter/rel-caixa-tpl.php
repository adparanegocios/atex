	...
	<body>
		...
		<div class="container_12">
            ...
            <div class="grid_12">
               ...
               <td width="300">
               <input type="hidden" name="time" id="time" value="{TEAMID}" />{DESCRICAO}
               ...
               <select name="user" id="user">
					<option value="" {DISABLED}>** Selecione um usu&aacute;rio **</option>
					<!-- BEGIN BLOCK_OPTION_USER -->
					<option value="{USERID}" {USUARIO_SELECIONA} {DISABLED}>{USERNAME}</option>
