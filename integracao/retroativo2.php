...
include_once 'C:/wamp/www/atex/conexaotemp1.php';
include_once 'C:/wamp/www/atex/conexaotemp2.php';
...
WHERE
	(convert(datetime,convert(varchar,o.CreateDate,103),103) >= convert(datetime,convert(varchar,'25/02/2018',103),103)) AND
	(convert(datetime,convert(varchar,o.CreateDate,103),103) <= convert(datetime,convert(varchar,'30/06/2018',103),103)) AND
	...
	((SELECT TOP 1 r.RefAdOrder FROM CoFulfillmentRec r (nolock) WHERE r.RefAdOrder = o.Id) IS NULL)
";
//echo nl2br($sql);exit;
$contador = 0;
$rs = $db->Execute ( $sql );
