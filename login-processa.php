...
if (! ((in_array ( $login, $vPermissao ['tem'] )) or (in_array ( $login, $vPermissao ['noticiario'] )) or (in_array ( $login, $vPermissao ['assistente'] )) or (in_array ( $login, $vPermissao ['web'] )) or (in_array ( $login, $vPermissao ['controladoria'] )))) {
	...
	if ($numlinhas != 0) {
		...
		if (in_array ( $login, $vPermissao ['assistente'] )) {
			$sAcesso = "assistente";
		}
