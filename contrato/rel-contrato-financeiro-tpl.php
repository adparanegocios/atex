...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head><title>Contrato - Financeiro (TOTVS)</title>
	...
	<body>
		...
		<div class="container_12">
            ...
            <div class="grid_12">
               ...
               <tr>
               <td colspan="7" style="color:#666">&nbsp;</td>
               </tr>
               </table>
               </form>
               </fieldset>
                        	...
                        	<thead>
                                <tr>
                                  <th style="width:20%">Contato</th>
                                    ...
                                    <th style="width:21%">Parcelas</th>  
                                    <th style="width:21%">Vencimentos </th>
                                    <th style="width:21%">% Mensal 01 </th>
                                    <th style="width:21%">% Mensal 02</th>
                                    <th style="width:21%">% Mensal 03</th>
                                    <th style="width:21%">% Mensal 04</th>
                                    <th style="width:21%">% Mensal 05</th>
                                    <th style="width:21%">% Mensal 06</th>
                                    <th style="width:21%">Total Utillizado </th>  
                                    <th style="width:21%">Última Programação </th>
                                </tr>
                            </thead>
                            <tbody>
                                <!-- BEGIN BLOCK_DADOS -->
                                <tr >
                                  <td {STYLE} class="align-center">{CONTATO}</td>
                                ...
                                <!-- <td {STYLE} class="align-center">{STATUS}</td> -->
                                    ...
                                    <td {STYLE} class="align-center">{PARCELAS}</td>
                                    <td {STYLE} class="align-center">{VENCIMENTOS}</td>
                                    <td {STYLE} class="align-center">{MENSAL1}</td>
                                    <td {STYLE} class="align-center">{MENSAL2}</td>
                                    <td {STYLE} class="align-center">{MENSAL3}</td>
                                    <td {STYLE} class="align-center">{MENSAL4}</td>
                                    <td {STYLE} class="align-center">{MENSAL5}</td>
                                    <td {STYLE} class="align-center">{MENSAL6}</td>
