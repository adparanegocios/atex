...
group by i.[Name], i.[Notes], i.[Status], c3.Name1, c3.Name2, c3.FederalId, i.StartDate, i.EndDate, n.[Description], d.[Description], n.Var1LowerLimit, d.Var1LowerLimit, n.Var2LowerLimit, d.Var2LowerLimit, i.RefAccountId
HAVING (
    	case 
        	when n.Var1LowerLimit is null 
            	then (sum (f.Var1Actual)*100)/d.Var1LowerLimit 
...
if ($rs) {
    ...
    <tr>
      ...
      <th width='234' scope='col'>Vendedor</th>
	...
	while ( $o = $rs->FetchNextObject () ) {
		...
		$ultimo = $o->ULTIMO;
		$vendedor = utf8_encode ( $o->VENDEDOR );
