	...
	<body>
		...
		<div class="container_12">
            ...
            <div class="grid_12">
               ...
               <span style="color: #999; font-size: 15px">Financeiro - <span style="color: #666">Vendedor</span></span>
                        ...
                        <table id="myTable" class="tablesorter">
                        	<thead>
                                <tr>
                                    ...
                                    <th style="width:21%">Cartao de debito</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{LOTACAO}</td>
                                    <td><a class="detalhe" href="detalhe-vendedor.php?area={AREA}&dt_inicio={DATA_INICIO}&dt_fim={DATA_FIM}&tipo_data={DATA_DE}&user={USER}&time={TIME}">Detalhe</a>
                                    </td>
                                </tr>
                                <!-- END BLOCK_LINHA -->
